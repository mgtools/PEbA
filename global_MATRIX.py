...
def main():
    ...
    trace_m = global_align(seq1, seq2, matrix, args.gopen, args.gext)

    # Get global alignment between seq1 and seq2 and write to file
    align1, align2 = traceback(trace_m, seq1, seq2)
    write_align(align1, align2, id1, id2, 'global_MATRIX', args.matrix+str(args.score), args.gopen, args.gext, args.file1)
