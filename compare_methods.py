...
def get_scores(method: str, ref: str) -> list:
    ...
    scores = []
    with open(f'{method}/compare_aligns_{ref}.log', 'r', encoding='utf8') as file:
        for line in file:
...
def graph_compare(m1: str, m2: str, ref: str, m1_scores: list, m2_scores: list):
    ...
    ax.legend([f'{m2_title} Avg: {m2_avg}', f'{m1_title} Avg: {m1_avg}'])
    plt.plot([0, 1], [0, 1], color='black')
    plt.savefig(f'data/graphs/{m1_title}-{m2_title}-comparison.png')
...
def main():
    ...
    graph_compare(args.m1, args.m2, args.r, m1_scores, m2_scores)
